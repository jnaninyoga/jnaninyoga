  ...
  return (
    <section className="container w-full px-4 py-10 flex flex-1 flex-col sm:flex-row justify-evenly bg-yoga-white gap-4 sm:gap-8">
        <div className="h-full flex flex-col items-center justify-between sm:gap-4">
            ...
            <h3 className="cinzel text-2xl font-bold uppercase">Classes</h3>
        </div>
        <div className="h-full flex flex-col items-center justify-between sm:gap-4">
            ...
            <h3 className="cinzel text-2xl font-bold uppercase">Studio</h3>
        </div>
        <div className="h-full flex flex-col items-center justify-between sm:gap-4">
            ...
            <h3 className="cinzel text-2xl font-bold uppercase">Yoga</h3>
        </div>
    </section>
  )
}

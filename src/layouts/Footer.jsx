    ...
    <footer className="bg-yoga-white flex flex-col py-8 px-10 items-center justify-between bottom-0 mt-5">
      ...
      <section className="container w-full font-medium flex justify-evenly items-center sm:flex-row flex-col gap-4">
        <ul className="sm:w-1/3 sm:order-1 order-4 cinzel flex flex-col sm:gap-2 gap-4" id="contactinfo">
          <li>
            <a className="flex items-start gap-4" href="https://goo.gl/maps/e4rGL1BPWrSXGZH77" referrerPolicy="no-referrer" rel="noreferrer" target="_blank">
          ...
          <li>
            <a className="flex items-start gap-4" href="tel:+212661286464" referrerPolicy="no-referrer" rel="noreferrer" target="_blank">
              <i className="fi fi-sr-phone-flip"></i>
              <h4 className="">212 661 286 464</h4>
            </a>
          </li>
          <li>
            <a className="flex items-start gap-4" href="mailto:contact@jnaninyoga.com" referrerPolicy="no-referrer" rel="noreferrer" target="_blank">
        ...
        <ul className="sm:w-[14%] w-full sm:order-3 order-3 cinzel flex flex-col sm:gap-2 gap-4" id="SocialMedia">
          <li>
            <a className="flex items-center gap-4" href="https://instagram.com/jnaninyoga" referrerPolicy="no-referrer" rel="noreferrer" target="_blank">
              <i className="fi fi-brands-instagram"></i>
              <h4 className="underline-offset-4 underline">@jnaninyoga</h4>
            </a>
          </li>
          <li>
            <a className="flex items-center gap-4" href="https://facebook.com/jnaninyoga" referrerPolicy="no-referrer" rel="noreferrer" target="_blank">
              <i className="fi fi-brands-facebook"></i>
              <h4 className="underline-offset-4 underline">@jnaninyoga</h4>
            </a>
          </li>
          <li>
            <a className="flex items-center gap-4" href="https://wa.me//212661286464" referrerPolicy="no-referrer" rel="noreferrer" target="_blank">

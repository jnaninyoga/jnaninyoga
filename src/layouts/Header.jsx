...
export default function Header() {
  ...
  return (
    <header role="menu" className={`fixed ${hideNavbar ? '-top-[100%] opacity-0' : 'top-0 opacity-100'} z-[9999] bg-yoga-white sm:px-10 px-4 h-14 sm:h-16 w-full flex justify-center items-center transition-all duration-300`}>

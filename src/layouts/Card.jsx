...
export default function Card({text="", twStyle="", title="", btn=false, linkTo="/"}) {
  ...
  return (
    <div ref={card} className={`py-6 px-6 w-[90%] sm:min-w-[1150px] flex items-center justify-between flex-col gap-4 bg-yoga-white texture-v sm:texture-h texture-opacity-80 ${twStyle} overflow-hidden`}>

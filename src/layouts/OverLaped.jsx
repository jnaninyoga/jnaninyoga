...
export default function OverLaped(props) {
  ...
  return (
    <section className="container flex items-center justify-center flex-col">
        ...
        <main className="relative px-4 py-8 sm:w-fit w-[92%] min-h-full h-fit sm:-translate-y-20 -translate-y-14 flex justify-center" style={{backgroundImage: `url(${textureBG})`}}>
            {props.children}
        </main>
    </section>
  )

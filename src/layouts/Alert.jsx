...
export default function Alert({title, message, confirm, cancel, type="info", onConfirm=() => console.log("Action Confirmed"), onCancel=() => console.log("Action Canceled")}) {
  ...
  return (
    <div className={`z-[99999] outline ${theme.outline} outline-2 -outline-offset-[12px] py-6 px-6 sm:w-[700px] w-[350px] flex items-center justify-between flex-col gap-4 bg-yoga-white bg-texture texture-v-1 sm:texture-h-1 texture-opacity-80 overflow-hidden`}>

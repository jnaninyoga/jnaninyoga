...
const Form = memo(({title, state, fields, insertElement, resetBtn,  submitBtn="Submit", ErrorMessage="Something went wrong, please try again", EmptyErrorMessage="Please fill all the required fields", onSubmit= async form => console.log("FORM DATA: ", form), onReset=e=>e.preventDefault(), dark=false, animatedIcon=false, errorTrigger=false}) => {
  ...
  return (
    <form ref={formRef} onSubmit={submitForm} className='lg:w-[50vw] w-full lg:px-20 sm:px-10 px-2 flex items-center flex-col'>
			...
			<div dir={currentLanguage.dir} ref={wrapper} className='w-full max-w-lg flex items-center justify-center gap-4 flex-col'>
			...
			<div dir='ltr' ref={btnsRef} className='w-full max-w-lg py-6 flex justify-around items-center z-50'>

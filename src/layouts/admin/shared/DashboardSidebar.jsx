...
export default function DashboardSidebar() {
  ...
  return (
    <aside role="menu" className={`lg:w-fit w-screen z-[100000] before:absolute before:h-screen before:w-screen before:pointer-events-none ${isMenuHidden ? "before:bg-none" : "before:bg-black before:bg-opacity-40 before:backdrop-blur-[2px]"} lg:bg-none flex flex-col transition-all duration-300 print:hidden print:before:hidden`}>
        ...
        <nav ref={dashboardSidebar} id="dashboardsidebar" className={`z-[9999] lg:relative fixed p-4 h-screen lg:w-full w-[70%] max-w-[250px] min-w-max flex items-center flex-col gap-7 texture-v-1 before:opacity-30 bg-yoga-white transition-all lg:left-0 ${isMenuHidden ? "-left-[120%] lg:left-0" : "left-0"} print:hidden`}>
